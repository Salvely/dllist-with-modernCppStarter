...
- Replace all occurrences of "Dllist" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Dllist` means the name of the project, while `dllist` is used in file names.
  - Remember to rename the `include/dllist` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
